...
let TelegramService = class TelegramService {
    ...
    async sendMessage(msg, options, chatId = this.options.chatId) {
        await this.bot.telegram.sendMessage(chatId, msg, {
            parse_mode: 'HTML',
            ...options,
        });
    }
    async sendPhoto(photo, msg, chatId = this.options.chatId) {
        await this.bot.telegram.sendPhoto(chatId, photo, msg
            ? {
                caption: msg,
            }
            : {});
